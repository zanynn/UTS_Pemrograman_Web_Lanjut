...
<section class="contact-form ptb-50">
    <div class="container text-center">
        <h2>Edit Product {{$bodykit->id}}</h2>

        <div class="row">
            <div class="col-md-8 col-md-offset-2 table-lol">
            <div class="col-md-6">
                <form action="/update/{{$bodykit->id}}" method="post">
                {{csrf_field()}}
                <div class="form-group"><br><br>
                <label for="id" class="zantext">Id Number</label>
                <input type="text"  class="form-control" name="id" value="{{$bodykit->id}}"></br>
                </div>
                <div class="form-group">
                    <label for="title" class="zantext">Title</label>
                    <input type="text" class="form-control"required="required" name="title" value="{{$bodykit->title}}"></br>
                </div>
                <div class="form-group">
                    <label for="image" class="zantext">Feature Image</label>
                    <input type="text" class="form-control"required="required" name="image" value="{{$bodykit->imageurl}}"></br>
                </div>
                </div><!-- /.col-md-6 -->
                <div class="col-md-6"><br><br>
                <div class="form-group">
                    <label for="content" class="zantext">Content</label>
                    <textarea class="form-control textareacontent"required="required" name="content">{{$bodykit->content}}</textarea></br>
                </div>
                </div><!-- /.col-md-6 -->
